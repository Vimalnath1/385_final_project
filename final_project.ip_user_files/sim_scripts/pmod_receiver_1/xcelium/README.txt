...
#
# Generated by export_simulation on Tue Apr 28 23:41:46 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './pmod_receiver.sh' script.

./pmod_receiver.sh -reset_run
...
./pmod_receiver.sh -noclean_files

For more information on the script, please type './pmod_receiver.sh -help'.
