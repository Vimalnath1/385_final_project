...
HD_PWD='C:/Users/vimal/Documents/ECE_385/final_project/final_project.runs/mb_usb_dlmb_bram_if_cntlr_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_usb_dlmb_bram_if_cntlr_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_usb_dlmb_bram_if_cntlr_2.tcl
